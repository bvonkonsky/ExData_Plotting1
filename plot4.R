...
plot4 <- function() {
  ...
  #upper left panel in plot
  with(twoDays, plot(Time, Global_active_power, type="l", xlab="", ylab="Gobal Active Power"))
  
  #upper right panel in plot
  with(twoDays, plot(Time, Voltage, type="l", xlab="datetime"))
  
  #lower left panel in plot
  ...
  #lower right panel in plot
  with(twoDays, plot(Time, Global_reactive_power, type="l", xlab="datetime"))
